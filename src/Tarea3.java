...
public class Tarea3 {
	...
	BufferedWriter writer = new BufferedWriter(new FileWriter("RadixSort.csv"));
	...
	/*
		...
		for(int i = 100000;i<=1000000;i=i+50000){
			...
			int[][] input = inputGenerator(0,i,100,i);
			for(int j=0;j<input.length;j++){
				int instructions=0;
				long timeEx=System.currentTimeMillis();
				instructions=sort.sort(input[j], i);
				timeEx=System.currentTimeMillis()-timeEx;
				writer.write(instructions+";"+timeEx+" \n");
			}
			writer.write("\n");
			input = null;
		}
